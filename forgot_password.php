...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!verify_csrf($_POST['csrf_token'] ?? '')) {
        ...
        if ($identifier === '') {
            ...
            // Search by staff number or email.
            ...
            // Always show the same message so people cannot
            ...
            $message =
                'If an active account matches the information provided, ' .
...
<div class="auth-card">
  ...
  <p class="subtitle">
    Enter your staff number or registered email address and we will send you
